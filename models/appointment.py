...
class AppointmentPrescriptionLines(models.Model):
    ...
    def _onchange_qty(self):
        for line in self:
            if line.medicine_id:
                line.medicine_id.stock -= line.qty
            if line.medicine_id and line.medicine_id.stock < 0:
                line.medicine_id.stock += line.qty
                raise ValidationError("Medicine Stock cannot be negative.")
            else:
                line.cost = line.qty * line.medicine_id.price
